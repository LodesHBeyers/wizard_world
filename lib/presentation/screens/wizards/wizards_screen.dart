...
class WizardsScreen extends ResponsiveLayout {
              ...
              Expanded(
                child: ref.watch(wizardsProvider).when(
                      data: (List<Wizard> wizards) {
                        final List<Wizard> randomWizards = <Wizard>[];
  ...
  Widget buildDesktop(BuildContext context) {
    return Scaffold(
      ...
      body: HookBuilder(builder: (BuildContext context) {
                                      ...
                                      .when(
                                        data: (Wizard embellishedWizard) =>
                                          ...
                                          children: <Widget>[
                                            ...
                                            for (Elixir elixir in selectedWizard
                                                .value!.elixirs)
                                              GestureDetector(
                                                onTap: () {
                                                  AppNavigator.pushNamed(
